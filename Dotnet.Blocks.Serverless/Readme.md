...
WORKDIR /src
COPY ["Dotnet.Blocks.Serverless.csproj", "Dotnet.Blocks.Serverless/"]
RUN dotnet restore "Dotnet.Blocks.Serverless/Dotnet.Blocks.Serverless.csproj"

WORKDIR "/src/Dotnet.Blocks.Serverless"
COPY . .
RUN dotnet build "Dotnet.Blocks.Serverless.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Dotnet.Blocks.Serverless.csproj" \
...
Execute unit tests
```
    cd "Dotnet.Blocks.Serverless/test/Dotnet.Blocks.Serverless.Tests"
    dotnet test
```

Deploy application
```
    cd "Dotnet.Blocks.Serverless/src/Dotnet.Blocks.Serverless"
